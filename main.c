/*
 ...
 Description = 
 The Microwave Oven Simulator is an embedded systems project designed to replicate the core functionality of a real microwave 
 oven using a microcontroller-based system. The primary objective of this application is to simulate how a microwave operates
 by implementing key control features such as time control, temperature control, and input/output operations.
 */
